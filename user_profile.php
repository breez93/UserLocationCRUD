...
<body>
    ...
    <div class="container">
        <table class="table">
            ...
            <td>
                <a href="address_update.php?edit=<?php echo $id?>" name="addressupdate" class="button">Edit</a>
                <a href="address_delete.php?delete=<?php echo $id;?>" name="addressdelete" class="button">Delete</a>
            </td>
