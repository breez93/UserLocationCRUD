...
<div class="container" id="Menu de Opções">
    <h3>Menu de Operações</h3>
    <a href="user_regist.php" name="registuser" class="button">Registar Utilizador</a>
    <a href="address_regist.php" name="registaddress" class="button">Registar Morada</a>
            ...
            if(mysqli_num_rows($return)>0){
             while($row=mysqli_fetch_assoc($result)){
                echo "<tr>
                  ...
                  <td>".$row["password"]."</td>";?>
                <td>
                    <a href="user_update.form.php?edit=<?php echo $row["IDuser"];?>" name="edit" class="button">Edit</a>
